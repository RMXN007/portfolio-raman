        ...
        <section id="about" ref={aboutRef} className="py-24 px-4 max-w-6xl mx-auto">
                    ...
                    <Card className="p-8 md:p-10 h-full">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <h2 className="text-2xl font-bold text-slate-100 italic font-mono">Biography</h2>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-8 about-element">
                    ...
                    <Card className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-100 font-medium leading-tight">B.Tech in IT</p>
                            <p className="text-zinc-500 text-xs mt-1">IET DAVV, Indore</p>
                        </div>
                    </Card>
                    ...
                    <Card className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-100 font-medium leading-tight">Indore, India</p>
                            <p className="text-zinc-500 text-xs mt-1">Available for Remote</p>
                        </div>
                    </Card>

                    {/* Focus Card */}
                    <Card className="p-6 flex items-center gap-4 bg-gradient-to-br from-zinc-900/50 to-orange-500/5">
                        <div className="p-3 rounded-lg bg-yellow-500/10 text-yellow-500">
                            <Sparkles size={20} />
                        </div>
                        <div>
                            <h3 className="text-xs font-bold uppercase tracking-widest text-yellow-500/80 mb-1">Current Focus</h3>
                            <p className="text-slate-100 font-medium leading-tight">Advanced DSA</p>
                            <p className="text-zinc-500 text-xs mt-1">MERN Optimization</p>
                        </div>
                    </Card>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 about-element">
                <Card className="p-6 flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="text-slate-100 font-bold mb-1">Clean Code Advocate</h4>
                        <p className="text-zinc-400 text-sm italic">Treating every project like a production-ready system with modularity at its core.</p>
                    </div>
                </Card>
                <Card className="p-6 flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="text-slate-100 font-bold mb-1">Full Stack Explorer</h4>
                        <p className="text-zinc-400 text-sm italic">Solving algorithmic puzzles using C++ while scaling the depths of the MERN stack.</p>
                    </div>
                </Card>
            </div>
        </section>
